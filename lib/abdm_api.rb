...
require "abdm_api/v1/abha/account"
...
module AbdmAPI
  ...
  def self.configure
    ...
    raise AbdmAPI::Error.new('healthcare_professional_base_url cannot be blank') if configuration.healthcare_professional_base_url.blank?
  end

  class Configuration
    attr_accessor :client_id, :client_secret, :api_base_url, :facility_base_url, :healthcare_professional_base_url
    ...
    def initialize
      ...
      @healthcare_professional_base_url = healthcare_professional_base_url
    end
  end
